    ...
    <div className="min-h-screen bg-gradient-to-br from-[#667eea] to-[#764ba2] flex items-center justify-center p-5 relative overflow-hidden font-sans">
      <style>
        {`
          ...
          .login-container {
            ...
            width: 100%;
            max-width: 420px;
            min-width: 320px; /* Added to prevent collapse on narrow windows */
          ...
          @media (max-width: 768px) { /* Adjusted breakpoint to 768px */
            .login-container {
              padding: 40px 30px;
              margin: 0 10px;
              min-width: 280px; /* Reduced min-width for smaller screens */
            }
            .login-title {
              font-size: 24px;
            }
      ...
      <div className="login-container">
        <div className="login-header">
          ...
          <p className="login-subtitle">Sign up for your MyDuka account</p>
        </div>
