...
class SupplyRequestStatus(Enum):
    pending = "pending"
    approved = "approved"
    declined = "declined"
...
class SupplyRequest(BaseModel):
    ...
    status = db.Column(PgEnum(SupplyRequestStatus, name="supply_status"), default=SupplyRequestStatus.pending)
...
class StockTransfer(BaseModel):
    ...
    status = db.Column(PgEnum(StockTransferStatus, name="transfer_status"), default=StockTransferStatus.pending)
